...
def get_cookie(username, password):
    ...
    # //点击登录按钮
    browser.find_element_by_id("J_SubmitStatic").click(); browser.switch_to_default_content()
    ...
    # //cookie取到了
    cookie = "; ".join([item["name"] + "=" + item["value"] for item in browser.get_cookies()]) //关闭浏览器

    browser.quit()

    return cookie
get_cookie("王湘英00","wxy15773978948@")